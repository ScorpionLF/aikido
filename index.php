        ...
        <div class="news">
            <div class="new_1">
                <div class="new_block">
                    ...
                    <div class="new"><p>
                        <?php echo (file_get_contents('./news/new_1.txt')); ?></p>
                    </div>
                </div>
            </div>
            <div class="new_2">
                <div class="new_block">
                    ...
                    <div class="new">
                        <p>В конце мая прошла плановая аттестация учеников Ametsuchi Dojo. Сенсеи федерации во
                            главе с Белоусовым Евгением Набиевичем были очень строги и "сдать на пояс" удалось единицам.
                            Хотя число участников было небывало большим - мероприятия заняло весь день. <br>
            ...
            <div class="new_3">
                <div class="new_block">
                    ...
                    <div class="new">
                        <p>В декабре прошел семинар Айкидо федерации Ametsuchi.
                            Традиционно был выбран зал Ак Барс, поскольку число участников снова бьет наши рекорды.<br>
                            Поздравляем всех успешно
                            сдавших на пояс, а тем, кому это не удалось желаем упорства и целеустремленности, ведь
                            истинная
                            сила
